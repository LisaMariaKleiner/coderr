...
class PlatformInfoTests(APITestCase):
    def test_platform_info_success(self):
        ...
        self.assertEqual(response.data['detail'], 'Die Basisinformationen wurden erfolgreich abgerufen.')

    def test_platform_info_internal_error(self):
